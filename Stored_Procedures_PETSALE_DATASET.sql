...
#In this exercise, we will create and execute a stored procedure to read data from a table on mysql phpadmin using SQL.

#1.We will create a stored procedure routine named RETRIEVE_ALL.
...
#2.To call the RETRIEVE_ALL routine
CALL RETRIEVE_ALL;

#We can view the created stored procedure routine RETRIEVE_ALL. On the left panel, expand the PETS database option and click on Procedures to view the procedure.

#3. Drop the stored procedure routine RETRIEVE_ALL
...
#In this exercise, we will create and execute a stored procedure to write/modify data in a table on MySQL using SQL.
...
CALL RETRIEVE_ALL;
# The value of Cat's Saleprice changed from 450.09 to 337.57
...
# The value of Parrot's Saleprice changed from 50.00 to 25.00

# 3.Drop the stored procedure routine UPDATE_SALEPRICE
